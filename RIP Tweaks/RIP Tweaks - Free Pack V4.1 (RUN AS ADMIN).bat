@ECHO off
title RIP Tweaks - Free - Requesting Admin
MODE 50,6
color 9
echo.
echo.
echo          RIP Tweaks - Free - Requesting Admin
...
color 8
echo. 
echo     %COL%[31mWelcome %USERNAME%, To RIP Tweaks V4.1 Free!
echo. 

goto warning

:warning
title RIP Tweaks - Free (Warning)
echo     %COL%[37mThere is %COL%[31mNO %COL%[37mSupport Whatsoever on Any Of The Free Packs, Everything You Do Is At
echo     %COL%[37mYour %COL%[31mOWN %COL%[37mRisk, We %COL%[31mRECOMMEND %COL%[37mCreating a Restore Point To Keep Your PC %COL%[31mSAFE.
echo.
echo     %COL%[90mType: "%COL%[31mskip%COL%[90m" to Proceed %COL%[31mWITHOUT%COL%[90m Creating a Restore Point.
echo     %COL%[90mType: "%COL%[31mrestore%COL%[90m" to Proceed %COL%[31mWITH%COL%[90m Creating a Restore Point.
echo.
echo     %COL%[37mWe Advise Creating One %COL%[31mMANUALLY%COL%[37m Just In Case the Automatic One Fails.
echo     Follow The %COL%[37mInstructions%COL%[37m and Read The %COL%[31mCautions%COL%[37m for a Safe Tweaking Experience.
echo.
set choice=
set /p choice=%COL%[31m    Your Choice: %COL%[91m
...
powershell -ExecutionPolicy Unrestricted -NoProfile Checkpoint-Computer -Description 'RIP Tweaks V4.1 Restore Point' 

:main

title RIP Tweaks Free V4.1
...
echo.       
echo.                                    
echo                               %COL%I__________.__         ___________                       
echo                               %COL%I\______   \__I_____   \_   _____/______   ____   ____  
echo                               %COL%I I       _/  \____ \   I    __) \_  __ \_/ __ \_/ __ \ 
echo                               %COL%I I    I   \  I  I_) )  I     \   I  I \/\  ___/\  ___/ 
echo                               %COL%I I____I_  /__I   __/   \___  /   I__I    \___ ) \___ )
echo                               %COL%I        \/   I__I          \/                \/     \/ 
echo. 
echo.                                                   %COL%[31mFree Edition
echo.
echo.
echo                                         %COL%[90m The Best Free FPS Boost Service!
echo                                  %COL%[90m10x More Performance With RIP Tweaks Paid Packs!
echo                                           %COL%[90mGet One Today at riptweaks.com
echo.
echo.
echo                              %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Power Tweaks   %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m GPU Tweaks   %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m Ping Tweaks
echo.
echo.   
echo                           %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[37m Input Tweaks   %COL%[31m[%COL%[37m 5 %COL%[31m]%COL%[37m Windows Tweaks  %COL%[31m[%COL%[37m 6 %COL%[31m]%COL%[37m Debloat Tweaks
echo.
echo.  
echo.                                  %COL%[31m[%COL%[37m 7 %COL%[31m]%COL%[31m RAM Tweaks    %COL%[31m[%COL%[37m 8 %COL%[31m]%COL%[31m Games    %COL%[31m[%COL%[37m 9 %COL%[31m]%COL%[31m Socials
echo.        
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:123456789 /n /m "%DEL% %COL%[31m                                            Type In Your Option > "
...
echo.
echo.
echo                                   %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Power Tweaks           %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m AMD CPU
echo.                                  %COL%[90mOptimize Power Settings      %COL%[90mOptimize Your AMD CPU
echo.                                  %COL%[90mFor More Performance         %COL%[90mFor Performance  
echo.
echo                                                 %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m Intel CPU
echo.                                                %COL%[90mOptimize Your Intel CPU
echo.                                                %COL%[90mFor Performance
echo.
echo.
echo.                                              %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:1234 /n /m "%DEL% %COL%[31m                                             Type In Your Option > "
set choice=%errorlevel%
...
echo.
echo.
echo                  %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m INTEL                  %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m AMD                   %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m NVIDIA
echo                  %COL%[90mGPU Tweaks For Intel GPUs    %COL%[90mGPU Tweaks for AMD GPUs     %COL%[90mGPU Tweaks For NVIDIA GPUs
echo                  %COL%[90mCan Be Used on All PC's.     %COL%[90mCan Be Used on All PC's.    %COL%[90mCan Be Used on All PC's. 
echo.
echo.
echo.
echo.                                                %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[31m Main Menu
echo.     
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:1234 /n /m "%DEL% %COL%[31m                                            Type In Your Option > "
...
echo.
echo.
echo                  %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Remove Input-Delay            %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m 16 Hex            %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m 32 Hex
...
echo. 
echo                              %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[37m Optimize Keyboard       %COL%[31m[%COL%[37m 5 %COL%[31m]%COL%[37m Optimize Mouse
echo.                             %COL%[90mKeyboard Tweaks For Faster    %COL%[90mMouse Tweaks For Faster
echo.                             %COL%[90mResponse and Lower Delay      %COL%[90mResponse and Lower Input Delay
echo.
echo.
echo.                                              %COL%[31m[%COL%[37m 6 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:123456 /n /m "%DEL% %COL%[31m                                             Type In Your Option > "
set choice=%errorlevel%
...
echo.
echo.
echo                           %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Reduce Ping                  %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m Boost Internet           
...
echo. 
echo.
echo.                                              %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:123 /n /m "%DEL% %COL%[31m                                             Type In Your Option > "
set choice=%errorlevel%
...
echo.
echo.
echo                           %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Disable All Animations     %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m DirectX Tweaks
echo.                          %COL%[90mDisable Useless Animations and   %COL%[90mOptimize DirectX For More FPS
echo.                          %COL%[90mTransitions for More FPS         %COL%[90mCan Be Used on All Types of PCs
echo.
echo                                             %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m Windows Tweaks   
echo.                                            %COL%[31m1000+ Windows Tweaks%COL%[90m For a  
...
echo.
echo.
echo                                   %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Cleanup             %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m Services
echo.                                  %COL%[90mGet Rid Of ALL Junk       %COL%[90mDisable Unecessary 
echo.                                  %COL%[90mand Temporary Files.      %COL%[90mBackground Services.   
echo.
echo                                               %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m Debloat
echo.                                              %COL%[90mRemove Unwanted Bloatware
echo.                                              %COL%[90mFor Both Windows 10/11.
echo.
echo.
echo.                                              %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
...
echo.
echo.
echo                                   %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Fortnite            %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m Valorant
echo.                                  %COL%[90mOptimize Fortnite For     %COL%[90mOptimize Valorant For    
echo.                                  %COL%[90mThe Best Performance      %COL%[90mThe Best Performance         
echo.
echo                                   %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m GTA 5               %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[37m Minecraft
echo.                                  %COL%[90mOptimize GTA 5 For        %COL%[90mOptimize Minecraft For
echo.                                  %COL%[90mThe Best Performance      %COL%[90mThe Best Performance           
echo.
echo.
echo.                                              %COL%[31m[%COL%[37m 5 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
echo.
set choice=
%SystemRoot%\System32\choice.exe /c:12345 /n /m "%DEL% %COL%[31m                                             Type In Your Option > "
set choice=%errorlevel%
...
echo.
echo.
echo                     %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m 4GB RAM               %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m 8GB RAM                %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m 16GB RAM
echo.                    %COL%[90mOptimize RAM and Lower      %COL%[90mOptimize RAM and Lower       %COL%[90mOptimize RAM and Lower
echo.                    %COL%[90mWindows Processes           %COL%[90mWindows Processes            %COL%[90mWindows Processes
echo. 
echo                                     %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[37m 32GB RAM            %COL%[31m[%COL%[37m 5 %COL%[31m]%COL%[37m Revert
echo.                                    %COL%[90mOptimize RAM and Lower    %COL%[90mRevert ALL Of The
echo.                                    %COL%[90mWindows Processes         %COL%[90mApplied RAM Tweaks
echo.
echo.
echo.                                              %COL%[31m[%COL%[37m 6 %COL%[31m]%COL%[31m Back (Main Menu)   
echo.     
...
echo.
echo.
echo                                   %COL%[31m[%COL%[37m 1 %COL%[31m]%COL%[37m Discord Server       %COL%[31m[%COL%[37m 2 %COL%[31m]%COL%[37m Website               
echo.                                  %COL%[90mJoin Our Discord Server    %COL%[90mCheck Out Our Website 
echo.                                  %COL%[90mdiscord.gg/riptweaks       %COL%[90mriptweaks.com  
echo. 
echo.                                           %COL%[31m[%COL%[37m 3 %COL%[31m]%COL%[37m YouTube
echo.                                           %COL%[90mSubscribe to Our YouTube Channel
echo.                                           %COL%[90myoutube.com/@riptweakss
echo.
echo.
echo                                                   %COL%[31m[%COL%[37m 4 %COL%[31m]%COL%[31m Main Menu
echo.
...
%SystemRoot%\System32\choice.exe /c:12345 /n /m "%DEL% %COL%[31m                                              Type In Your Option > "
set choice=%errorlevel%
IF /I "%choice%"=="1" start "" https://discord.com/invite/riptweaks/
IF /I "%choice%"=="2" start "" https://riptweaks.com  
IF /I "%choice%"=="3" start "" https://youtube.com/@riptweakss
IF /I "%choice%"=="4" goto main
